...
function PoliceMarker({ position }: { position: LatLngExpression }) {
    ...
    const barrierIconSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path fill="#464655" stroke="#000" strokeWidth="2" d="M44.138 317.793v8.828c0 34.127 128.981 79.448 211.862 79.448s211.862-45.321 211.862-79.448v-8.828H44.138z"/>
    </svg>`;
